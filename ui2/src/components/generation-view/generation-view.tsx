...
const GenerationTokenComponent = React.memo((props: GenerationTokenProps) => {
    ...
    const textColor = React.useMemo(() => {
        ...
        const reversed =
            ...
            metric.toLowerCase().includes("entropy")
                ? true
                : false;
...
const GenerationView = () => {
    ...
    switch (metric) {
        case "confidence":
            metricPercetiles = generationStore.confidenceTenPercentiles.value;
            break;
        case "perplexity":
            metricPercetiles = generationStore.perplexityTenPercentiles.value;
            break;
        case "lastPerplexity":
            metricPercetiles =
