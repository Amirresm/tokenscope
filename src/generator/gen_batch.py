...
class BatchGenerator:
    ...
    def generate_yield(
        ...
        log_metric=False,
    ) -> typing.Generator[list[tuple[StepResult, bool]], None, None]:
    ...
    def _loop(
        ...
        for i, result in enumerate(results):
            ...
            step_result = StepResult(
                ...
                tags=tags,
                attention_snapshot=attention_results[i] if attention_results else None,
            )
    ...
    def record_attentions(self, attention: tuple[torch.Tensor]):
        ...
        print(f"target len: {tgt_len}, source len: {src_len}, current idx: {current_tok_index}")
